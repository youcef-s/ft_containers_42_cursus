...
/*   Updated: 2022/10/29 10:39:29 by ylabtaim         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	stack_main(void) {
	...
	cout << "\033[0;32m** Constructors && operator= && size **\033[0m\n";
	{
		...
		std::stack<int, std::vector<int> > stk(vect);
		std::stack<int, std::vector<int> > stk2(stk);
	...
	cout << "\033[0;32m** relational operators **\033[0m\n";
	{
		std::vector<int>	vect1(3, 10);
		std::vector<int>	vect2(4, 20);
		std::stack<int, std::vector<int> > stack1(vect1);
		std::stack<int, std::vector<int> > stack2(vect2);
...
int main(void) {
	...
	cout << "\033[0;31m** std_vector tests **\033[0m\n";
	vector_main();
	cout << "\033[0;31m** std_map tests **\033[0m\n";
	map_main();
	cout << "\033[0;31m** std_stack tests **\033[0m\n";
	stack_main();
